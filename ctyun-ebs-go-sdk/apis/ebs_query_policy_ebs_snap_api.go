...
type EbsQueryPolicyEbsSnapRequest struct {
	...
	SnapshotPolicyID   string `json:"snapshotPolicyID,omitempty"`   /*  快照策略ID。  */
	SnapshotPolicyName string `json:"snapshotPolicyName,omitempty"` /*  快照策略名称。  */
}

type EbsQueryPolicyEbsSnapResponse struct {
	StatusCode  int32                                   `json:"statusCode,omitempty"`  /*  返回状态码（800为成功，900为处理中/失败，详见errorCode）。  */
...
type EbsQueryPolicyEbsSnapReturnObjResponse struct {
	SnapshotPolicyTotalCount int32                                                       `json:"snapshotPolicyTotalCount,omitempty"` /*  自动快照策略总数量。  */
...
type EbsQueryPolicyEbsSnapReturnObjSnapshotPolicyListResponse struct {
	...
	RetentionTime            int32  `json:"retentionTime,omitempty"`            /*  创建快照的保留时间，-1代表永久保留。  */
	ProjectID                string `json:"projectID,omitempty"`                /*  企业项目。  */
	BoundDiskNum             int32  `json:"boundDiskNum,omitempty"`             /*  关联云硬盘的数量。  */
