...
type EbsQueryEbsListRequest struct {
	...
	PageNo         int32  `json:"pageNo,omitempty"`         /*  默认为1。  */
	PageSize       int32  `json:"pageSize,omitempty"`       /*  默认为10，最大值为300。  */
	DiskStatus     string `json:"diskStatus,omitempty"`     /*  云硬盘状态。取值为：<br>●attached：已挂载。<br>●unattached：未挂载。<br>●detaching：卸载中。<br>●creating：创建中。<br>●expired：已过期。<br>●freezing：已冻结。  */
	AzName         string `json:"azName,omitempty"`         /*  可用区。  */
	ProjectID      string `json:"projectID,omitempty"`      /*  企业项目。  */
	DiskType       string `json:"diskType,omitempty"`       /*  云硬盘类型。取值为：<br>●SATA：普通IO。<br>●SAS：高IO。<br>●SSD：超高IO。<br>●FAST-SSD：极速型SSD、<br>●XSSD-0、XSSD-1、XSSD-2：X系列云硬盘。  */
	DiskMode       string `json:"diskMode,omitempty"`       /*  云硬盘模式。取值为：<br>●VBD：虚拟块存储设备。<br>●ISCSI：小型计算机系统接口。<br>●FCSAN：光纤通道协议的SAN网络。  */
	MultiAttach    string `json:"multiAttach,omitempty"`    /*  是否共享盘。取值为：<br>●true：共享盘。<br>●false：非共享盘。  */
	IsSystemVolume string `json:"isSystemVolume,omitempty"` /*  是否为系统盘。取值为：<br>●true：系统盘。<br>●false：数据盘。  */
	IsEncrypt      string `json:"isEncrypt,omitempty"`      /*  是否加密盘。取值为：<br>●true：加密盘。<br>●false：非加密盘。  */
	QueryContent   string `json:"queryContent,omitempty"`   /*  模糊匹配盘的信息，包括盘ID、盘名称、挂载主机ID、挂载主机名称等信息。  */
}
...
type EbsQueryEbsListReturnObjResponse struct {
	...
	DiskTotal    int32                                       `json:"diskTotal,omitempty"`    /*  总数。  */
...
type EbsQueryEbsListReturnObjDiskListResponse struct {
	...
	CreateTime      int64                                                  `json:"createTime,omitempty"`      /*  创建时刻，epoch时戳，精度为毫秒。  */
	UpdateTime      int64                                                  `json:"updateTime,omitempty"`      /*  更新时刻，epoch时戳，精度为毫秒。  */
	ExpireTime      int64                                                  `json:"expireTime,omitempty"`      /*  过期时刻，epoch时戳，精度为毫秒。  */
