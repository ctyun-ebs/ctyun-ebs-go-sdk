...
type EbsQuerySizeEbsSnapResponse struct {
	StatusCode  int32                                 `json:"statusCode,omitempty"`  /*  返回状态码（800为成功，900为失败/处理中）。  */
...
type EbsQuerySizeEbsSnapReturnObjResponse struct {
	SnapshotTotalSize  int32                                          `json:"snapshotTotalSize,omitempty"`  /*  region下的所有云硬盘快照的使用量，单位为B。  */
	SnapshotTotalCount int32                                          `json:"snapshotTotalCount,omitempty"` /*  云硬盘快照数量。  */
...
type EbsQuerySizeEbsSnapReturnObjDetailsResponse struct {
	...
	SnapshotSize int32 `json:"snapshotSize,omitempty"` /*  单个类型的云硬盘的快照使用量，单位为B。  */
}
